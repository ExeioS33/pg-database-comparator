...
if __name__ == "__main__":
    ...
    input_schema = (
        input("Enter the schema name to compare (leave blank for default schema): ")
        or None
    )
    ...
    logger.info(f"Status of connection : {db_handler}")
    ...
    logger.info(f"Connection closed from : {db_handler}")
