...
class DatabaseComparatorGUI:
    def __init__(self, master):
        ...
        self.label_db1 = tk.Label(
            master, text="Nom du serveur de la première DB (ex: PG-TEST):"
        )
        ...
        self.label_db2 = tk.Label(
            master, text="Nom du serveur de la seconde DB (ex: PG-DWH):"
        )
        ...
        self.compare_button = tk.Button(
            master, text="Comparer", command=self.compare_databases
        )
    ...
    def compare_databases(self):
        ...
        try:
            ...
            self.text_output.insert(
                tk.END, "Regarder le dossier 'data' pour voir les CSV de comparaisons."
            )
